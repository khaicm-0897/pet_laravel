                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form-horizontal" id="form" method="POST"
                                action="{{ route(
                                    isset($user) ? 'admin.blogs.update' : 'admin.blogs.store',
                                    isset($user) ? $user->id : '')
                                }}"
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                                                <div class="form-group required
                                                    ...
                                                    <input type="text" class="form-control" name="title"
                                                        value="{{$user && $user->title ? $user->title : old('title')}}"
                                                ...
                                                <div class="form-group required
                                                    ...
                                                    <div class="input-group date" id="datetime">
                                                        ...
                                                        <input type="text" class="form-control datetimepicker blog"
                                                            ...
                                                            autocomplete="off"
                                                            value="{{isset($user->publish_date) ?
                                                                $user->publish_date : old('publish_date') }}">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function () {
            uploadImage({
                ...
                imageInit: "{!! $user && $user->avatar ? $user->avatar : old('avatar')!!}",
