                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                ...
                                <a href="{{route('admin.users.create')}}" style="color: white;" role="button"
                                class="">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <input type="hidden" id="getData" name="getData" data-model="Blog"
                                data-title="{{ Breadcrumbs::generate($breadcrumb)[0]->title }}" data-link="users">
                            <form id="formSearch" action="/admin/users" method="GET">
                                <div class="row">
                            ...
                            <div id="gird">
                                @include('admin.pages.users.gird', ['userList' => $userList])
                            </div>
                        </div>
                    </div>
                </div>
