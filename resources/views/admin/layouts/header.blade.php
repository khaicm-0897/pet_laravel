                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="/admin">
                        <img class="brand-logo" alt="stack admin logo"
                            src="{{asset('/admin/app-assets/images/logo/stack-logo-light.png')}}"/>
                        <h2 class="brand-text">Pet Laravel</h2>
                    </a>
                </li>
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    <li class="dropdown nav-item mega-dropdown">
                        <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Pet Laravel</a>
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" alt="First slide"
                                            src="{{asset('/admin/app-assets/images/slider/slider-2.png')}}"/>
                    ...
                    <li class="nav-item d-none d-md-block">
                        <a class="view-website-tab-new nav-link nav-link-expand" href="/"
                            target="_blank" title="Mở giao diện web">
                            <i class="ficon ft-external-link"></i>
                        </a>
                    </li>
                    <li class="nav-item d-none d-md-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    ...
                                    <span class="notification-tag badge
                                        badge-default badge-danger float-right m-0">5 New</span>
                                </h6>
                            </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    ...
                                    <span class="notification-tag badge
                                        badge-default badge-warning float-right m-0">4 New</span>
                                </h6>
                            </li>
                            <li class="scrollable-container media-list">
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="{{
                                                    asset('/admin/app-assets/images/portrait/small/avatar-s-1.png')}}"
                                                    alt="avatar"/>
                                                <i></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                <img src="{{
                                                    asset('/admin/app-assets/images/portrait/small/avatar-s-2.png')}}"
                                                    alt="avatar"/>
                                                <i></i>
                                            </span>
                                        </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                <img src="{{
                                                    asset('/admin/app-assets/images/portrait/small/avatar-s-3.png')}}"
                                                    alt="avatar"/>
                                                <i></i>
                                            </span>
                                        </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                <img src="{{
                                                    asset('/admin/app-assets/images/portrait/small/avatar-s-6.png')}}"
                                                    alt="avatar"/>
                                                <i></i>
                                            </span>
                                        </div>
